    ...
    <fieldset>
        ...
        {else}
            ...
            <div class="margin-form" style="padding-left:15px" id="sm_import_orders_credentials">
                ...
                <p style="display:none"><label>{l s='Inventory endpoint' mod='sellermania'}</label> <input type="text" name="sm_inventory_endpoint" value="{$sm_inventory_endpoint}" style="width:50%" /></p>
