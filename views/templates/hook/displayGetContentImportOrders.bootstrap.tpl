                    ...
                    <div id="sm_import_orders_credentials" class="clearfix"{if $sm_import_orders eq 'no' || $sm_import_orders eq ''} style="display: none;"{/if}>
                                                                        ...
                                                                        {if isset($sm_marketplace.delivery)}
                                                                            <select class="select2" name="SM_MKP_DELIVERY_{$marketplace_code}_{$ps_carrier['id_carrier']}" id="SM_MKP_DELIVERY_{$marketplace_code}_{$ps_carrier['id_carrier']}" style="width:100%">
                                                                                ...
                                                                                {foreach from=$sm_marketplace.delivery item=sm_marketplace_delivery}
                                                                                    <option value="{$sm_marketplace_delivery}"{if isset($sm_marketplace.delivery_value[$ps_carrier['id_carrier']]) and $sm_marketplace.delivery_value[$ps_carrier['id_carrier']] == $sm_marketplace_delivery} selected{/if}>{$sm_marketplace_delivery}</option>
                                                                                {/foreach}
                                                                            </select>
                                                                        {else}
                        ...
                        <div class="config-section-wrapper">
                            ...
                            <div class="config-section-body">
                                ...
                                <div class="form-group clearfix">
                                    <label class="col-lg-4">{l s='Product match' mod='sellermania'} <span title="{l s='This important parameter allows you to match your Prestashop references when you receive an order. The SKU code that will be transmitted by Sellermania in the order will be "matched" with the code you specify in this menu. If you don\'t know, choose "automatic".' mod='sellermania'}"><span class="sm-icon sm-info"></span></span></label>
                                    <div class="col-lg-8">
                        ...
                        <div class="config-section-wrapper">
                            ...
                            <div class="config-section-body">
                                <p>
                                    ...
                                    {l s='If you fill in your tracking numbers manually on each order, you don\'t need this parameter' mod='sellermania'}.<br/>
